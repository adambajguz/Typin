namespace Typin.Tests
{
    ...
    public partial class ArgumentBindingSpecs
    {
        ...
        public void Property_of_custom_type_that_implements_IEnumerable_can_only_be_bound_if_that_type_has_a_constructor_accepting_an_array()
        {
            ...
            // Act & assert
            var ex = Assert.Throws<TypinException>(() => CommandHelper.ResolveCommand<UnsupportedEnumerablePropertyTypeCommand>(input));
        ...
        public void Property_of_non_nullable_type_can_only_be_bound_if_the_argument_value_is_set()
        {
            ...
            // Act & assert
            var ex = Assert.Throws<TypinException>(() => CommandHelper.ResolveCommand<AllSupportedTypesCommand>(input));
            _output.WriteLine(ex.Message);
        }
        ...
        public void Property_must_have_a_type_supported_by_the_framework_in_order_to_be_bound()
        {
            ...
            // Act & assert
            var ex = Assert.Throws<TypinException>(() => CommandHelper.ResolveCommand<UnsupportedPropertyTypeCommand>(input));
            _output.WriteLine(ex.Message);
        }
        ...
        public void Property_annotated_as_a_required_option_must_always_be_set()
        {
            ...
            // Act & assert
            var ex = Assert.Throws<TypinException>(() => CommandHelper.ResolveCommand<RequiredOptionCommand>(input));
            _output.WriteLine(ex.Message);
        }
        ...
        public void Property_annotated_as_a_required_option_must_always_be_bound_to_at_least_one_value_if_it_expects_multiple_values()
        {
            ...
            // Act & assert
            var ex = Assert.Throws<TypinException>(() => CommandHelper.ResolveCommand<RequiredArrayOptionCommand>(input));
            _output.WriteLine(ex.Message);
        }
        ...
        public void Property_annotated_as_parameter_must_always_be_bound_to_some_value()
        {
            ...
            // Act & assert
            var ex = Assert.Throws<TypinException>(() => CommandHelper.ResolveCommand<ParametersCommand>(input));
            _output.WriteLine(ex.Message);
        }
        ...
        public void All_provided_parameter_arguments_must_be_bound_to_corresponding_properties()
        {
            ...
            // Act & assert
            var ex = Assert.Throws<TypinException>(() => CommandHelper.ResolveCommand<NoParameterCommand>(input));
            _output.WriteLine(ex.Message);
        }
    }
}