namespace Typin.Exceptions.Mode
{
    ...
    /// </summary>
    public abstract class ModeException : ResolverException
    {
        /// <summary>
        ...
        protected ModeException(string? message) : base(message)
        {
        ...
        protected ModeException(string? message, Exception? innerException) : base(message, innerException)
        {
