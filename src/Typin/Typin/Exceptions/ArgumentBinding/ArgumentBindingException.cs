namespace Typin.Exceptions.ArgumentBinding
{
    ...
    public abstract class ArgumentBindingException : TypinException
    {
        ...
        protected ArgumentBindingException(ArgumentSchema? schema)
        {
        ...
        protected ArgumentBindingException(ArgumentSchema? schema, string? message) : base(message)
        {
            ArgumentSchema = schema;
        }
        ...
        protected ArgumentBindingException(ArgumentSchema? schema, SerializationInfo info, StreamingContext context) : base(info, context)
        {
            ArgumentSchema = schema;
        }
        ...
        protected ArgumentBindingException(ArgumentSchema? schema, string? message, Exception? innerException) : base(message, innerException)
        {
            ArgumentSchema = schema;
        }
    }
