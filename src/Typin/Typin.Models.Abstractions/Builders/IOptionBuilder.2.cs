namespace Typin.Models.Builders
{
    ...
    public interface IOptionBuilder<TModel, TProperty> : IBuilder<IOptionSchema>
        where TModel : class, IModel
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IOptionBuilder<TModel, TProperty> NoFallback()
        {
        ...
        /// <returns></returns>
        IOptionBuilder<TModel, TProperty> Fallback(string? variableName);
