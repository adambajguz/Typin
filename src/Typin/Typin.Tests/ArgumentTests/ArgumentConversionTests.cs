namespace Typin.Tests.ArgumentTests
{
    ...
    public class ArgumentConversionTests
    {
        ...
        [InlineData(nameof(SupportedArgumentTypesCommand) + @" --half-nullable -15.123", @"{ ""half-nullable"": -15.123 }")]
        [InlineData(nameof(SupportedArgumentTypesCommand) + @" --half-nullable 15.123", @"{ ""half-nullable"": 15.123 }")]
        ...
        [InlineData(nameof(SupportedArgumentTypesCommand) + @" --dateonly-nullable ""28 Apr 1995""", @"{ ""dateonly-nullable"": ""1995-04-28"" }")]
        [InlineData(nameof(SupportedArgumentTypesCommand) + @" --dateonly-nullable 2020-11-12", @"{ ""dateonly-nullable"": ""2020-11-12"" }")]
        [InlineData(nameof(SupportedArgumentTypesCommand) + @" --dateonly-nullable", @"{ ""dateonly-nullable"": null }")]

        [InlineData(nameof(SupportedArgumentTypesCommand) + @" --timeonly-nullable 00:14:59", @"{ ""timeonly-nullable"": ""00:14:59"" }")]
        [InlineData(nameof(SupportedArgumentTypesCommand) + @" --timeonly-nullable 23:59:59.145", @"{ ""timeonly-nullable"": ""23:59:59.145"" }")]
        [InlineData(nameof(SupportedArgumentTypesCommand) + @" --timeonly-nullable", @"{ ""timeonly-nullable"": null }")]
