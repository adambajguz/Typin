namespace TypinExamples.TypinWeb.Logging
{
    ...
    /// </summary>
    internal class FileLoggerOptionsSetup : ConfigureFromConfigurationOptions<WebLoggerOptions>
    {
        /// <summary>
        /// Constructor that takes the IConfiguration instance to bind against.
        /// </summary>
        public FileLoggerOptionsSetup(ILoggerProviderConfiguration<WebLoggerProvider> providerConfiguration)
