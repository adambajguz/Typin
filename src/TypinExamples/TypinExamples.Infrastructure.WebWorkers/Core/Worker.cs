namespace TypinExamples.Infrastructure.WebWorkers.Core
{
        ...
        where T : class, IWebWorkerEntryPoint
    {
        ...
        private async Task<IWorkerBackgroundService<T>> CreateBackgroundServiceAsync(WorkerInitOptions workerInitOptions = null)
        {
        ...
        public async Task InitAsync(WorkerInitOptions initOptions)
        {
            ...
            await _jsRuntime.InvokeVoidAsync(
                ...
                new WorkerInitOptions
                {
                    ...
                    //new[] {
                    //    "TypinExamples.Infrastructure.WebWorkers.Core.dll",
                    //    "TypinExamples.Infrastructure.WebWorkers.Abstractions.dll",
                    //    "netstandard.dll",
                    //    "mscorlib.dll",
                    //    "System.dll",
                    //    "System.Core.dll",
